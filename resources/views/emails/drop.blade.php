                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <h4 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal; font-weight: bold;" align = "center">Warning For having 5 absent</h>
                            ...
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <ul style="padding: 0; margin: 0 0 10px 0; list-style-type: disc;">
                                        ...
                                        <li style="margin:0 0 10px 30px;"><b>You are already drop the subject</b></li>
                                        <li style="margin:0 0 10px 30px;"><b>for having 5 absents in the subject</b></li>
