...
<head>
  ...
  <title>Student Monitoring System | Sign Up</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="#"><b>Student</b>Monitoring</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <div class="form-group has-feedback">
       <input id="type_id" type="text" class="form-control{{ $errors->has('type_id') ? ' is-invalid' : '' }}" name="type_id" value="{{ old('type_id') }}" placeholder="ID"   required autofocus>
